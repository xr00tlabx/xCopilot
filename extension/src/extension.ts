...
export function activate(context: vscode.ExtensionContext) {
    console.log('🚀 xCopilot extension is now active!');

    // Registrar o provider primeiro, antes de qualquer outra coisa
        ...
        resolveWebviewView(view: vscode.WebviewView) {
            ...
            view.webview.onDidReceiveMessage(async (msg) => {
                ...
                if (msg.type === 'ask' && msg.prompt) {
                    console.log('🤖 Processing ask request:', msg.prompt);
    ...
    // Registrar o provider IMEDIATAMENTE
    try {
        console.log('📝 Registering WebviewViewProvider for xcopilotPanel...');
        ...
        vscode.window.showErrorMessage(`Erro crítico ao registrar xCopilot: ${error}`);
